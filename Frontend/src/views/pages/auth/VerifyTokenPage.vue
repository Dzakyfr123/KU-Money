<template>
  <div
    class="min-h-screen bg-linear-to-br from-green-50 via-white to-purple-50 flex items-center justify-center p-6"
  >
    <div class="w-full max-w-md">
      ...
      >
        ...
        <template #actions>
          <RouterLink
            to="/app/dashboard"
            class="inline-block w-full py-3 px-4 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition"
          >
            Masuk ke Dashboard
          </RouterLink>
        </template>
      ...
      >
        ...
        <template #actions>
          <RouterLink
            ...
            class="inline-block w-full py-3 px-4 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition mb-3"
          >
  ...
  try {
    ...
    await Swal.fire({
      ...
      html: `
        ...
        <p class="mt-2">Status akun: <strong class="text-green-600">FREE</strong></p>
      `,
