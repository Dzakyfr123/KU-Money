    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8">
        <div class="text-center mb-6">
          ...
          >
            <i class="mdi mdi-email-check text-4xl text-green-600"></i>
          </div>
        ...
        <button
          ...
          class="w-full py-3 px-4 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition mb-4"
        >
          <span v-if="isLoading">
