      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-12">
          <h1 class="text-4xl md:text-5xl font-extrabold text-slate-800 mb-4">
            Tentang <span class="text-green-600">Ku‑Money</span>
          </h1>
        ...
        <div class="prose prose-lg max-w-none">
          <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
            <p class="text-gray-700 leading-relaxed mb-6">
              <span class="font-semibold text-green-600">Ku‑Money</span> adalah aplikasi SaaS
          ...
          <div class="text-center mt-12">
            <RouterLink
              to="/auth/register"
              class="inline-block px-8 py-4 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700/90 transition shadow-lg"
            >
