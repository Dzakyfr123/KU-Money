    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        ...
        <button
          ...
          class="w-full py-3 px-4 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700 transition"
        >
          Upgrade ke Pro
        </button>
      </div>
      ...
      <div
        ...
        class="bg-white rounded-xl border-2 border-green-600 p-6 hover:shadow-lg transition relative"
      >
        <div
