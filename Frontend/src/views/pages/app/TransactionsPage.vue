<template>
  <div class="pb-20">
    ...
    <div class="bg-linear-to-r from-green-500 to-purple-600 rounded-xl p-6 text-white mb-6">
        ...
        <div class="flex items-center gap-2 relative month-picker-container">
          ...
          >
            <input
              ...
              type="month"
              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 text-gray-800"
