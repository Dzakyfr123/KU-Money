  ...
  <div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
      ...
      <button
        ...
        class="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700 transition shadow-md hover:shadow-lg flex items-center justify-center gap-2 text-sm sm:text-base"
      >
    ...
    <div class="bg-linear-to-r from-green-500 to-purple-600 rounded-xl p-4 sm:p-6 text-white mb-6">
