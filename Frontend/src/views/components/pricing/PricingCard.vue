<template>
  <div
    :class="[
      ...
      isPopular
        ? 'bg-green-600 text-white shadow-2xl scale-105 border-2 border-green-600'
  ...
  >
    ...
    <!-- Price -->
    <div class="mb-6">
      <div :class="['text-4xl font-extrabold', isPopular ? 'text-white' : 'text-green-600']">
        {{ formattedPrice }}
      </div>
    ...
    <RouterLink
      ...
      :class="[
        ...
        isPopular
          ...
          : 'bg-green-600 text-white hover:bg-green-700/90',
      ]"
    >
      {{ buttonText }}
    </RouterLink>
