        ...
        <div>
          ...
          <div class="relative icon-picker-container">
            <button
              ...
              class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent transition flex items-center justify-between"
            >
              <div class="flex items-center gap-3">
                <i :class="[form.icon || 'mdi mdi-wallet', 'text-2xl text-green-600']"></i>
            ...
            >
              <div class="p-3">
                <input
                  ...
                  class="w-full px-3 py-2 border border-gray-300 rounded-lg mb-3 focus:outline-none focus:ring-2 focus:ring-green-600"
                />
                <div class="grid grid-cols-6 gap-2">
                  <button
                    ...
                    class="p-3 hover:bg-green-50 rounded-lg transition flex items-center justify-center"
                    :class="{ 'bg-green-100 border-2 border-green-600': form.icon === icon }"
                  >
                    <i :class="[icon, 'text-xl text-green-600']"></i>
                  </button>
                </div>
              </div>
            </div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input
              ...
              type="text"
              placeholder="0"
              class="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent transition"
              required
            />
          </div>
        </div>
