<template>
  <div class="relative custom-select-container">
    <button
      ...
      :disabled="disabled"
      :class="[
        'w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent transition flex items-center justify-between',
        disabled
      ...
      <div class="py-2">
        ...
        >
          ...
          <i
            ...
            class="mdi mdi-check text-green-600"
          ></i>
        </button>
        <button
          ...
          :class="[
            'w-full px-4 py-3 text-left hover:bg-gray-50 transition flex items-center justify-between',
            isSelected(option) ? 'bg-green-50 text-green-600' : 'text-gray-700',
          ]"
        >
          <span>{{ getOptionLabel(option) }}</span>
          <i v-if="isSelected(option)" class="mdi mdi-check text-green-600"></i>
        </button>
