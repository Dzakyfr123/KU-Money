<template>
  <button
    ...
    :class="[
      ...
      variant === 'default'
        ? 'bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-gray-300'
        : variant === 'rounded-xl'
          ? 'bg-green-600 text-white rounded-xl hover:bg-green-700/90 disabled:bg-gray-400'
          : 'bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-gray-300',
    ]"
    @click="$emit('click')"
  >
