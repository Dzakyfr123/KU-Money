  ...
  >
    ...
    >
      ...
      <div class="p-6 space-y-6">
        <!-- Package Info -->
        <div v-if="packageData" class="bg-green-50 rounded-xl p-4">
        ...
        <div class="flex gap-3 pt-4">
          ...
          <button
            ...
            class="flex-1 py-3 px-4 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
