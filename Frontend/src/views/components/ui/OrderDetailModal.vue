  ...
  >
    ...
    >
      ...
      <div v-if="order" class="p-6 space-y-6">
        ...
        <!-- Package Details -->
        <div v-if="packageInfo" class="bg-green-50 rounded-xl p-4 space-y-3">
        ...
        <div v-if="order.status === 'unpaid' && order.checkoutUrl" class="pt-4">
          <a
            ...
            class="w-full block text-center py-3 px-4 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700 transition"
          >
