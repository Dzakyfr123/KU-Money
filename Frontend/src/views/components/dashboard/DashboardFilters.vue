        ...
        <div class="py-2">
          <button
            ...
            :class="[
              ...
              selectedAccountId === null ? 'bg-green-50 text-green-600' : 'text-gray-700',
            ]"
          >
            <span>Semua Dompet</span>
            <i v-if="selectedAccountId === null" class="mdi mdi-check text-green-600"></i>
          </button>
          <button
            ...
            :class="[
              'w-full px-4 py-2 text-left text-sm hover:bg-gray-50 flex items-center justify-between',
              selectedAccountId === account._id ? 'bg-green-50 text-green-600' : 'text-gray-700',
            ]"
          >
            ...
            <i v-if="selectedAccountId === account._id" class="mdi mdi-check text-green-600"></i>
          </button>
        </div>
      </div>
    </div>
      ...
      >
        <div class="py-2">
          ...
          >
            ...
            <i v-if="selectedDateFilter === option.value" class="mdi mdi-check text-green-600"></i>
          </button>
        </div>
      </div>
    </div>
