  ...
  <section class="py-20 bg-gray-50" id="advantages">
    <div class="max-w-6xl mx-auto px-6">
      ...
      <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <div
          class="rounded-2xl bg-white border border-green-600/10 p-6 shadow-sm hover:shadow-md transition"
        >
          <div
            class="h-12 w-12 rounded-xl bg-primary/10 text-green-600 flex items-center justify-center mb-4"
          >
            <svg
        ...
        <div
          class="rounded-2xl bg-white border border-green-100 p-6 shadow-sm hover:shadow-md transition"
        >
          <div
            class="h-12 w-12 rounded-xl bg-accent/10 text-accent flex items-center justify-center mb-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6"
        ...
        >
          <div
            class="h-12 w-12 rounded-xl bg-info/10 text-info flex items-center justify-center mb-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6"
