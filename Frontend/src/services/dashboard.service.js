...
export async function getExpensesByCategory(params = {}) {
  try {
    const response = await axios.get('/dashboard/expenses-by-category', { params })
    return response.data
  } catch (error) {
...
export async function getIncomeVsExpenses(params = {}) {
  try {
    const response = await axios.get('/dashboard/income-vs-expenses', { params })
    return response.data
  } catch (error) {
...
export async function getRecentTransactions(params = {}) {
  try {
    const response = await axios.get('/dashboard/recent-transactions', { params })
    return response.data
  } catch (error) {
